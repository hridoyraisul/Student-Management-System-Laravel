    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('list') }}">All Student</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('search') }}">Search Student</a>
                </li>
                <li class="nav-item">
            ...
            <div class="col-lg-8 col-md-10 mx-auto">
                <ul class="list-inline text-center">
                    <li class="list-inline-item">
                        <a href="http://www.twitter.com/raisul_hridoy">
                <span class="fa-stack fa-lg">
                  ...
                  <i class="fab fa-twitter fa-stack-1x fa-inverse"></i>
                    ...
                    <li class="list-inline-item">
                        <a href="http://www.facebook.com/exheartz">
                <span class="fa-stack fa-lg">
                  <i class="fas fa-circle fa-stack-2x"></i>
                  <i class="fab fa-facebook-f fa-stack-1x fa-inverse"></i>
                    ...
                    <li class="list-inline-item">
                        <a href="http://www.instagram.com/raisulhridoy">
                <span class="fa-stack fa-lg">
                  <i class="fas fa-circle fa-stack-2x"></i>
                ...
                <p class="copyright text-muted">Copyright &copy; Raisul Hridoy 2020</p>
            </div>
        </div>
    </div>
</footer>
